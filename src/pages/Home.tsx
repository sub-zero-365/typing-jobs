...
import AnimatedLinks from "../components/Links/AnimatedLinks.js";
                    ...
                    <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
                        ...
                        <div className="flex justify-center flex-wrap gap-x-4 gap-y-6 items-center py-5">
                            ...
                            <Button
                                ...
                                className=" hover:border-none capitalize
                        px-10 py-6 text-xl bg-transparent border-white border-[4px] rounded-none "
                            >
                                <AnimatedLinks to={
                                    user ? "/" : "/home/auth"}
                        ...
                        <motion.p
                            ...
                            className="mt-4 font-normal text-lg mb-6 text-neutral-300 max-w-lg text-center mx-auto ">
                            Upload your handwritten notes, audio recordings, or scans and get them accurately typed by our skilled professionals. Free up your time and focus on what matters!
                        </motion.p>
                    </div>
